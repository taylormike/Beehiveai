var Bot, Channel, Client, DM, Editor, EventEmitter, Group, HttpsProxyAgent, Log, Message, Team, User, WebSocket, https, querystring,
...
Client = (function(_super) {
  ...
  Client.prototype.filesEdit = function() {
    ...
    this.editor.snippetEdit(params); 
  };
  ...
  Client.prototype._apiCall = function(method, params, callback, overrideToken) {
